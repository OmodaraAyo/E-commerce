    ...
    <div>
      <div className=' flex flex-col md:flex-row justify-center items-start py-0 w-full bg-[#F2F0F1] gap-1 px-7 md:pl-9 xl:px-40 overflow-hidden'>
        <div className='flex flex-col justify-center items-start'>
          ...
          <button onClick={handleNavigateToAllProductsPage} className="w-full sm:w-auto md:block bg-black px-8 py-4 rounded-full text-white animate-bounce mt-3">Shop Now</button>
